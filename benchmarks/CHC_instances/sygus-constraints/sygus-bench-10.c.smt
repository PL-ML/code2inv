(set-info :original "/tmp/sea-l1DOpl/10.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@entry @unknown_0)
                ...
                main@%_4_0
                (= main@%_5_0 (ite (>= main@%_1_0 0) (< main@%_1_0 3) false))
                main@%_5_0
                (= main@%_6_0 (< main@%_3_0 3))
                main@%_6_0
...
(rule (let ((a!1 (and (main@_bb main@%y.0.i_0 main@%x.0.i_0 @unknown_0)
                ...
                (=> main@_bb1_0 (= main@%_13_0 (+ main@%x.0.i_0 2)))
                (=> main@_bb1_0 (= main@%_14_0 (+ main@%y.0.i_0 2)))
...
(rule (let ((a!1 (and (main@_bb main@%y.0.i_0 main@%x.0.i_0 @unknown_0)
                ...
                (=> main@_bb2_0 (= main@%_17_0 (= main@%x.0.i_0 4)))
                (=> main@_bb2_0
