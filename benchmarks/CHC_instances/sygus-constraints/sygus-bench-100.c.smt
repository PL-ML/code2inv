(set-info :original "/tmp/sea-E49Fzg/100.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
    ...
    (main@_bb main@%y.0.i_1 main@%x.0.i_1 main@%_1_0)))
(rule (let ((a!1 (and (main@_bb main@%y.0.i_0 main@%x.0.i_0 main@%_1_0)
                true
                (= main@%_8_0 (> main@%x.0.i_0 0))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) main@%_8_0)
                (=> main@_bb1_0 (= main@%_10_0 (+ main@%y.0.i_0 1)))
                ...
                (=> (and main@_bb_1 main@_bb1_0) (= main@%y.0.i_1 main@%_10_0))
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%x.0.i_2 main@%x.0.i_1))
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%y.0.i_2 main@%y.0.i_1)))))
  (=> a!1 (main@_bb main@%y.0.i_2 main@%x.0.i_2 main@%_1_0))))
(rule (let ((a!1 (and (main@_bb main@%y.0.i_0 main@%x.0.i_0 main@%_1_0)
                true
                (= main@%_8_0 (> main@%x.0.i_0 0))
                (=> main@_bb2_0 (and main@_bb2_0 main@_bb_0))
                (=> (and main@_bb2_0 main@_bb_0) (not main@%_8_0))
                (=> main@_bb2_0 (= main@%_13_0 (= main@%y.0.i_0 main@%_1_0)))
                (=> main@_bb2_0 (not main@%_13_0))
                (=> main@_bb2_0 (= main@%_14_0 (xor main@%_13_0 true)))
