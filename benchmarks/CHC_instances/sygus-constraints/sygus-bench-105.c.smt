(set-info :original "/tmp/sea-4U5SxC/105.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@_bb main@%x.0.i_0 main@%_1_0)
                ...
                (=> main@_bb2_0 (= main@%_15_0 (< main@%_1_0 0)))
                (=> main@_bb2_0 (= main@%_16_0 (= main@%x.0.i_0 main@%_1_0)))
                (=> main@_bb2_0
                    (= main@%or.cond.i_0 (or main@%_15_0 main@%_16_0)))
                (=> main@_bb2_0 (not main@%or.cond.i_0))
                (=> main@_bb2_0 (= main@%_17_0 (xor main@%or.cond.i_0 true)))
