(set-info :original "/tmp/sea-RUS9Vf/106.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
         ...
         (= main@%_4_0 @unknown_0)
         (= main@%_6_0 @unknown_0)
         (= main@%_8_0 (<= main@%_1_0 main@%_3_0))
         main@%_8_0
         (= main@%_9_0 (< main@%_5_0 1))
         main@%_9_0
         (=> main@_bb_0 (and main@_bb_0 main@entry_0))
         main@_bb_0
         (=> (and main@_bb_0 main@entry_0) (= main@%m.0.i_0 main@%_3_0))
    ...
    (main@_bb main@%m.0.i_1 main@%_1_0 main@%k.0.i_1)))
(rule (let ((a!1 (and (main@_bb main@%m.0.i_0 main@%_1_0 main@%k.0.i_0)
                true
                (= main@%_11_0 (< main@%k.0.i_0 1))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) main@%_11_0)
                (=> main@_bb1_0 (= main@%_13_0 (< main@%m.0.i_0 main@%_1_0)))
                (=> main@_bb1_0
                    (= main@%.m.0.i_0
                       (ite main@%_13_0 main@%_1_0 main@%m.0.i_0)))
                (=> main@_bb1_0 (= main@%_14_0 (+ main@%k.0.i_0 1)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb1_0))
                main@_bb_1
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%m.0.i_1 main@%.m.0.i_0))
                (=> (and main@_bb_1 main@_bb1_0) (= main@%k.0.i_1 main@%_14_0))
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%m.0.i_2 main@%m.0.i_1))
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%k.0.i_2 main@%k.0.i_1)))))
  (=> a!1 (main@_bb main@%m.0.i_2 main@%_1_0 main@%k.0.i_2))))
(rule (let ((a!1 (and (main@_bb main@%m.0.i_0 main@%_1_0 main@%k.0.i_0)
                true
                (= main@%_11_0 (< main@%k.0.i_0 1))
                (=> main@_bb2_0 (and main@_bb2_0 main@_bb_0))
                (=> (and main@_bb2_0 main@_bb_0) (not main@%_11_0))
                (=> main@_bb2_0 (= main@%_16_0 (< main@%_1_0 main@%m.0.i_0)))
                (=> main@_bb2_0 main@%_16_0)
