(set-info :original "/tmp/sea-noi8Hq/107.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@_bb main@%m.0.i_0 main@%_1_0 main@%k.0.i_0)
                true
                (= main@%_9_0 (< main@%k.0.i_0 1))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) main@%_9_0)
                (=> main@_bb1_0 (= main@%_11_0 (< main@%m.0.i_0 main@%_1_0)))
                (=> main@_bb1_0
                    (= main@%.m.0.i_0
                       (ite main@%_11_0 main@%_1_0 main@%m.0.i_0)))
                (=> main@_bb1_0 (= main@%_12_0 (+ main@%k.0.i_0 1)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb1_0))
                main@_bb_1
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%m.0.i_1 main@%.m.0.i_0))
                (=> (and main@_bb_1 main@_bb1_0) (= main@%k.0.i_1 main@%_12_0))
                (=> (and main@_bb_1 main@_bb1_0)
...
(rule (let ((a!1 (and (main@_bb main@%m.0.i_0 main@%_1_0 main@%k.0.i_0)
                ...
                (=> main@_bb2_0 (= main@%_14_0 (> main@%_1_0 main@%m.0.i_0)))
                (=> main@_bb2_0 main@%_14_0)
