(set-info :original "/tmp/sea-UvZk4c/117.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
    ...
    (main@_bb main@%sn.0.i_1 main@%x.0.i_1 @unknown_0)))
(rule (let ((a!1 (and (main@_bb main@%sn.0.i_0 main@%x.0.i_0 @unknown_0)
                true
                (= main@%_11_0 @unknown_0)
...
(rule (let ((a!1 (and (main@_bb main@%sn.0.i_0 main@%x.0.i_0 @unknown_0)
                ...
                (=> main@_bb2_0 (= main@%_18_0 (= main@%sn.0.i_0 (- 1))))
                (=> main@_bb2_0
                    (= main@%_19_0 (= main@%sn.0.i_0 main@%x.0.i_0)))
                (=> main@_bb2_0
                    (= main@%or.cond.i_0 (or main@%_18_0 main@%_19_0)))
                (=> main@_bb2_0 (not main@%or.cond.i_0))
                (=> main@_bb2_0 (= main@%_20_0 (xor main@%or.cond.i_0 true)))
