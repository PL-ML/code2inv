(set-info :original "/tmp/sea-zhf2I4/122.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@_bb main@%sn.0.i_0 main@%_3_0 main@%i.0.i_0)
                ...
                (=> main@_bb2_0 (= main@%_18_0 (= main@%sn.0.i_0 main@%_3_0)))
                (=> main@_bb2_0 (= main@%_19_0 (= main@%sn.0.i_0 0)))
                (=> main@_bb2_0
