(set-info :original "/tmp/sea-gpx0B_/124.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@_bb main@%_5_0 main@%_7_0 main@%y.0.i_0 main@%x.0.i_0)
                ...
                main@_bb_1
                (=> (and main@_bb_1 main@_bb1_0) (= main@%x.0.i_1 main@%_11_0))
                (=> (and main@_bb_1 main@_bb1_0) (= main@%y.0.i_1 main@%_12_0))
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%x.0.i_2 main@%x.0.i_1))
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%y.0.i_2 main@%y.0.i_1)))))
  (=> a!1 (main@_bb main@%_5_0 main@%_7_0 main@%y.0.i_2 main@%x.0.i_2))))
(rule (let ((a!1 (=> main@_bb2_0 (= main@%_14_0 (not (= main@%_5_0 main@%_7_0))))))
(let ((a!2 (and (main@_bb main@%_5_0 main@%_7_0 main@%y.0.i_0 main@%x.0.i_0)
                ...
                a!1
                (=> main@_bb2_0 (= main@%_15_0 (= main@%y.0.i_0 0)))
                (=> main@_bb2_0
                    (= main@%or.cond.i_0 (or main@%_14_0 main@%_15_0)))
                (=> main@_bb2_0 (not main@%or.cond.i_0))
                (=> main@_bb2_0 (= main@%_16_0 (xor main@%or.cond.i_0 true)))
