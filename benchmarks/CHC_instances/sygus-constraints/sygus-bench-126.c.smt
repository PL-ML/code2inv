(set-info :original "/tmp/sea-hx8VwU/126.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
         ...
         (=> (and main@_bb_0 main@entry_0) (= main@%y.0.i_0 main@%_7_0))
         (=> (and main@_bb_0 main@entry_0) (= main@%x.0.i_1 main@%x.0.i_0))
         (=> (and main@_bb_0 main@entry_0) (= main@%y.0.i_1 main@%y.0.i_0)))
    (main@_bb main@%_5_0 main@%_7_0 main@%y.0.i_1 main@%x.0.i_1)))
(rule (let ((a!1 (and (main@_bb main@%_5_0 main@%_7_0 main@%y.0.i_0 main@%x.0.i_0)
                true
                (= main@%_15_0 (= main@%x.0.i_0 0))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) (not main@%_15_0))
                (=> main@_bb1_0 (= main@%_17_0 (+ main@%x.0.i_0 (- 1))))
                (=> main@_bb1_0 (= main@%_18_0 (+ main@%y.0.i_0 (- 1))))
                (=> main@_bb_1 (and main@_bb_1 main@_bb1_0))
                main@_bb_1
                (=> (and main@_bb_1 main@_bb1_0) (= main@%x.0.i_1 main@%_17_0))
                (=> (and main@_bb_1 main@_bb1_0) (= main@%y.0.i_1 main@%_18_0))
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%x.0.i_2 main@%x.0.i_1))
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%y.0.i_2 main@%y.0.i_1)))))
  (=> a!1 (main@_bb main@%_5_0 main@%_7_0 main@%y.0.i_2 main@%x.0.i_2))))
(rule (let ((a!1 (=> main@_bb2_0 (= main@%_20_0 (not (= main@%_5_0 main@%_7_0))))))
(let ((a!2 (and (main@_bb main@%_5_0 main@%_7_0 main@%y.0.i_0 main@%x.0.i_0)
                true
                (= main@%_15_0 (= main@%x.0.i_0 0))
                (=> main@_bb2_0 (and main@_bb2_0 main@_bb_0))
                (=> (and main@_bb2_0 main@_bb_0) main@%_15_0)
                a!1
                (=> main@_bb2_0 (= main@%_21_0 (= main@%y.0.i_0 0)))
                (=> main@_bb2_0
                    (= main@%or.cond.i_0 (or main@%_20_0 main@%_21_0)))
                (=> main@_bb2_0 (not main@%or.cond.i_0))
                (=> main@_bb2_0 (= main@%_22_0 (xor main@%or.cond.i_0 true)))
