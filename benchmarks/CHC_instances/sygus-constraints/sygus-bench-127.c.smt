(set-info :original "/tmp/sea-_OX9qN/127.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
    ...
    (main@_bb main@%y.0.i_1 main@%_5_0 main@%_7_0 main@%x.0.i_1)))
(rule (let ((a!1 (and (main@_bb main@%y.0.i_0 main@%_5_0 main@%_7_0 main@%x.0.i_0)
                true
  ...
  (=> a!1 (main@_bb main@%y.0.i_2 main@%_5_0 main@%_7_0 main@%x.0.i_2))))
(rule (let ((a!1 (=> main@_bb2_0 (= main@%_20_0 (not (= main@%y.0.i_0 0))))))
(let ((a!2 (and (main@_bb main@%y.0.i_0 main@%_5_0 main@%_7_0 main@%x.0.i_0)
                true
                (= main@%_15_0 (= main@%x.0.i_0 0))
                (=> main@_bb2_0 (and main@_bb2_0 main@_bb_0))
                (=> (and main@_bb2_0 main@_bb_0) main@%_15_0)
                a!1
                (=> main@_bb2_0 (= main@%_21_0 (= main@%_5_0 main@%_7_0)))
                (=> main@_bb2_0
