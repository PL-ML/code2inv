(set-info :original "/tmp/sea-i57sfr/128.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@_bb main@%x.0.i_0 main@%_3_0)
                true
                (= main@%_5_0 (< main@%x.0.i_0 main@%_3_0))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) main@%_5_0)
                (=> main@_bb1_0 (= main@%_7_0 (+ main@%x.0.i_0 main@%x.0.i_0)))
...
(rule (let ((a!1 (and (main@_bb main@%x.0.i_0 main@%_3_0)
                ...
                (=> main@_bb2_0 (= main@%_9_0 (> main@%x.0.i_0 0)))
                (=> main@_bb2_0 (not main@%_9_0))
                (=> main@_bb2_0 (= main@%_10_0 (xor main@%_9_0 true)))
