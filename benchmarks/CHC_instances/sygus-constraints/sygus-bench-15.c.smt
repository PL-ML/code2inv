(set-info :original "/tmp/sea-5bpPmQ/15.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
    ...
    (main@_bb @unknown_0 main@%m.0.i_1 main@%x.0.i_1 main@%_1_0)))
(rule (let ((a!1 (and (main@_bb @unknown_0 main@%m.0.i_0 main@%x.0.i_0 main@%_1_0)
                true
                (= main@%_3_0 (< main@%x.0.i_0 main@%_1_0))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) main@%_3_0)
                (=> main@_bb1_0 (= main@%_5_0 @unknown_0))
                (=> main@_bb1_0 (= main@%_7_0 (= main@%_6_0 0)))
                (=> main@_bb1_0
                    (= main@%m.0.x.0.i_0
                       (ite main@%_7_0 main@%m.0.i_0 main@%x.0.i_0)))
                (=> main@_bb1_0 (= main@%_8_0 (+ main@%x.0.i_0 1)))
  ...
  (=> a!1 (main@_bb @unknown_0 main@%m.0.i_2 main@%x.0.i_2 main@%_1_0))))
(rule (let ((a!1 (and (main@_bb @unknown_0 main@%m.0.i_0 main@%x.0.i_0 main@%_1_0)
                true
                (= main@%_3_0 (< main@%x.0.i_0 main@%_1_0))
                (=> main@_bb2_0 (and main@_bb2_0 main@_bb_0))
                (=> (and main@_bb2_0 main@_bb_0) (not main@%_3_0))
                (=> main@_bb2_0 (= main@%_10_0 (< main@%_1_0 1)))
                (=> main@_bb2_0 (= main@%_11_0 (< main@%m.0.i_0 main@%_1_0)))
                (=> main@_bb2_0
                    (= main@%or.cond.i_0 (or main@%_10_0 main@%_11_0)))
                (=> main@_bb2_0 (not main@%or.cond.i_0))
                (=> main@_bb2_0 (= main@%_12_0 (xor main@%or.cond.i_0 true)))
