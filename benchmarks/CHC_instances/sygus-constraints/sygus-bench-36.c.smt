(set-info :original "/tmp/sea-1rBPee/36.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
    ...
    (main@_bb main@%c.0.i_1 @unknown_0)))
(rule (let ((a!1 (and (main@_bb main@%c.0.i_0 @unknown_0)
                true
                (= main@%_3_0 @unknown_0)
                (= main@%_5_0 (= main@%_4_0 0))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) (not main@%_5_0))
                (=> main@_bb1_0 (= main@%_7_0 @unknown_0))
                (=> main@_bb1_0 (= main@%_9_0 (= main@%_8_0 0)))
                (=> main@_bb1_0 (= main@%_10_0 (= main@%c.0.i_0 40)))
                (=> main@_bb2_0 (and main@_bb2_0 main@_bb1_0))
                (=> (and main@_bb2_0 main@_bb1_0) (not main@%_9_0))
                (=> main@_bb2_0 (= main@%not..i_0 (xor main@%_10_0 true)))
                (=> main@_bb2_0 (= main@%_12_0 (ite main@%not..i_0 1 0)))
                (=> main@_bb2_0
                    (= main@%c.0..i_0 (+ main@%c.0.i_0 main@%_12_0)))
                (=> main@_bb3_0 (and main@_bb3_0 main@_bb1_0))
                (=> (and main@_bb3_0 main@_bb1_0) main@%_9_0)
                (=> main@_bb3_0
                    (= main@%.c.0.i_0 (ite main@%_10_0 1 main@%c.0.i_0)))
                (=> main@_bb_1
  ...
  (=> a!1 (main@_bb main@%c.0.i_3 @unknown_0))))
(rule (let ((a!1 (and (main@_bb main@%c.0.i_0 @unknown_0)
                true
                (= main@%_3_0 @unknown_0)
                (= main@%_5_0 (= main@%_4_0 0))
                ...
                (=> main@_bb4_0 (= main@%_15_0 (< main@%c.0.i_0 41)))
                (=> main@_bb4_0 (not main@%_15_0))
                (=> main@_bb4_0 (= main@%_16_0 (xor main@%_15_0 true)))
