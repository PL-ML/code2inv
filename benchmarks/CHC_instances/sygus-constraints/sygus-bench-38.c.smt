(set-info :original "/tmp/sea-40k6Ht/38.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
    ...
    (main@_bb main@%c.0.i_1 @unknown_0 main@%_1_0)))
(rule (let ((a!1 (and (main@_bb main@%c.0.i_0 @unknown_0 main@%_1_0)
                true
                (= main@%_4_0 @unknown_0)
                (= main@%_6_0 (= main@%_5_0 0))
                (= main@%_7_0 (= main@%c.0.i_0 main@%_1_0))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) (not main@%_6_0))
                (=> main@_bb1_0 (= main@%_9_0 (+ main@%c.0.i_0 1)))
                (=> main@_bb1_0 (= main@%c.1.i_0 (ite main@%_7_0 1 main@%_9_0)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb1_0))
                main@_bb_1
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%c.0.i_1 main@%c.1.i_0))
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%c.0.i_2 main@%c.0.i_1)))))
  (=> a!1 (main@_bb main@%c.0.i_2 @unknown_0 main@%_1_0))))
(rule (let ((a!1 (and (main@_bb main@%c.0.i_0 @unknown_0 main@%_1_0)
                true
                (= main@%_4_0 @unknown_0)
                (= main@%_6_0 (= main@%_5_0 0))
                ...
                (=> (and main@_bb2_0 main@_bb_0) main@%_6_0)
                (=> main@_bb2_0 (= main@%.not.i_0 (xor main@%_7_0 true)))
                (=> main@_bb2_0 (= main@%_11_0 (> main@%c.0.i_0 (- 1))))
                (=> main@_bb2_0
                    (= main@%or.cond.i_0 (or main@%_11_0 main@%.not.i_0)))
