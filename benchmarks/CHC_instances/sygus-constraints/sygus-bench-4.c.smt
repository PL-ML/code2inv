(set-info :original "/tmp/sea-EoLS5J/4.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
    ...
    (main@_bb main@%x.0.i_1 main@%_3_0 main@%y.0.i_1)))
(rule (let ((a!1 (and (main@_bb main@%x.0.i_0 main@%_3_0 main@%y.0.i_0)
                true
                (= main@%_5_0 (< main@%x.0.i_0 500))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) main@%_5_0)
                (=> main@_bb1_0 (= main@%_7_0 (+ main@%x.0.i_0 1)))
                (=> main@_bb1_0 (= main@%_8_0 (> main@%_3_0 main@%y.0.i_0)))
                (=> main@_bb1_0
                    (= main@%y.0..i_0 (ite main@%_8_0 main@%y.0.i_0 main@%_3_0)))
  ...
  (=> a!1 (main@_bb main@%x.0.i_2 main@%_3_0 main@%y.0.i_2))))
(rule (let ((a!1 (and (main@_bb main@%x.0.i_0 main@%_3_0 main@%y.0.i_0)
                true
                (= main@%_5_0 (< main@%x.0.i_0 500))
                (=> main@_bb2_0 (and main@_bb2_0 main@_bb_0))
                (=> (and main@_bb2_0 main@_bb_0) (not main@%_5_0))
                (=> main@_bb2_0 (= main@%_10_0 (< main@%_3_0 main@%y.0.i_0)))
                (=> main@_bb2_0 main@%_10_0)
