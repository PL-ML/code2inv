(set-info :original "/tmp/sea-DavA8U/40.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@_bb main@%c.0.i_0 main@%_3_0 @unknown_0)
                ...
                (=> (and main@_bb1_0 main@_bb_0) (not main@%_8_0))
                (=> main@_bb1_0 (= main@%_10_0 @unknown_0))
                (=> main@_bb1_0 (= main@%_12_0 (= main@%_11_0 0)))
                (=> main@_bb2_0 (and main@_bb2_0 main@_bb1_0))
                (=> (and main@_bb2_0 main@_bb1_0) (not main@%_12_0))
                (=> main@_bb2_0 (= main@%_14_0 (> main@%c.0.i_0 main@%_3_0)))
                (=> main@_bb2_0 (= main@%_15_0 (ite main@%_14_0 1 0)))
                (=> main@_bb2_0
                    (= main@%.c.0.i_0 (+ main@%c.0.i_0 main@%_15_0)))
                (=> main@_bb3_0 (and main@_bb3_0 main@_bb1_0))
                (=> (and main@_bb3_0 main@_bb1_0) main@%_12_0)
                (=> main@_bb3_0 (= main@%_17_0 (= main@%c.0.i_0 main@%_3_0)))
                (=> main@_bb3_0
                    (= main@%.c.01.i_0 (ite main@%_17_0 1 main@%c.0.i_0)))
                (=> main@_bb_1
                    (or (and main@_bb_1 main@_bb3_0)
                        (and main@_bb_1 main@_bb2_0)))
                main@_bb_1
                (=> (and main@_bb_1 main@_bb3_0)
                    (= main@%c.0.i_1 main@%.c.01.i_0))
                (=> (and main@_bb_1 main@_bb2_0)
...
(rule (let ((a!1 (and (main@_bb main@%c.0.i_0 main@%_3_0 @unknown_0)
                ...
                (=> main@_bb4_0 (= main@%_19_0 (= main@%c.0.i_0 main@%_3_0)))
                (=> main@_bb4_0 (= main@%_20_0 (> main@%c.0.i_0 (- 1))))
                (=> main@_bb4_0
                    (= main@%or.cond.i_0 (or main@%_19_0 main@%_20_0)))
                (=> main@_bb4_0 (not main@%or.cond.i_0))
                (=> main@_bb4_0 (= main@%_21_0 (xor main@%or.cond.i_0 true)))
