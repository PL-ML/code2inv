(set-info :original "/tmp/sea-p3NyEz/42.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@_bb main@%c.0.i_0 main@%_3_0 @unknown_0)
                ...
                (=> main@_bb4_0
                    (= main@%_20_0 (or main@%_19_0 main@%notlhs.i_0)))
                (=> main@_bb4_0 (not main@%_20_0))
                (=> main@_bb4_0 (= main@%_21_0 (xor main@%_20_0 true)))
