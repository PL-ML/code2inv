(set-info :original "/tmp/sea-GhSKTK/45.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@_bb main@%c.0.i_0 main@%_3_0 @unknown_0)
                ...
                (=> main@_bb4_0 (= main@%_18_0 (= main@%c.0.i_0 main@%_3_0)))
                (=> main@_bb4_0 (= main@%_19_0 (> main@%c.0.i_0 (- 1))))
                (=> main@_bb4_0
                    (= main@%or.cond.i_0 (or main@%_18_0 main@%_19_0)))
                (=> main@_bb4_0 (not main@%or.cond.i_0))
                (=> main@_bb4_0 (= main@%_20_0 (xor main@%or.cond.i_0 true)))
