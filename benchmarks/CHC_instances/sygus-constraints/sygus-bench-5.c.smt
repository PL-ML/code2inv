(set-info :original "/tmp/sea-wROVQn/5.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
    ...
    (main@_bb main@%x.0.i_1 main@%_5_0 main@%y.0.i_1 main@%_1_0)))
(rule (let ((a!1 (and (main@_bb main@%x.0.i_0 main@%_5_0 main@%y.0.i_0 main@%_1_0)
                true
                (= main@%_7_0 (< main@%x.0.i_0 main@%_1_0))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) main@%_7_0)
                (=> main@_bb1_0 (= main@%_9_0 (+ main@%x.0.i_0 1)))
                (=> main@_bb1_0 (= main@%_10_0 (> main@%_5_0 main@%y.0.i_0)))
                (=> main@_bb1_0
                    (= main@%y.0..i_0
                       (ite main@%_10_0 main@%y.0.i_0 main@%_5_0)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb1_0))
                main@_bb_1
                (=> (and main@_bb_1 main@_bb1_0) (= main@%x.0.i_1 main@%_9_0))
  ...
  (=> a!1 (main@_bb main@%x.0.i_2 main@%_5_0 main@%y.0.i_2 main@%_1_0))))
(rule (let ((a!1 (and (main@_bb main@%x.0.i_0 main@%_5_0 main@%y.0.i_0 main@%_1_0)
                true
                (= main@%_7_0 (< main@%x.0.i_0 main@%_1_0))
                (=> main@_bb2_0 (and main@_bb2_0 main@_bb_0))
                (=> (and main@_bb2_0 main@_bb_0) (not main@%_7_0))
                (=> main@_bb2_0 (= main@%_12_0 (> main@%_1_0 0)))
                (=> main@_bb2_0 (= main@%_13_0 (< main@%_5_0 main@%y.0.i_0)))
                (=> main@_bb2_0
