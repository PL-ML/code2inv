(set-info :original "/tmp/sea-E8l9pm/53.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@_bb main@%c.0.i_0 main@%_3_0 @unknown_0)
                ...
                (=> main@_bb2_0 (= main@%_20_0 (> main@%c.0.i_0 main@%_3_0)))
                (=> main@_bb2_0 (= main@%_21_0 (ite main@%_20_0 1 0)))
                (=> main@_bb2_0
                    (= main@%.c.0.i_0 (+ main@%c.0.i_0 main@%_21_0)))
                (=> main@_bb3_0 (and main@_bb3_0 main@_bb1_0))
                (=> (and main@_bb3_0 main@_bb1_0) main@%_18_0)
                (=> main@_bb3_0 (= main@%_23_0 (= main@%c.0.i_0 main@%_3_0)))
                (=> main@_bb3_0
                    (= main@%.c.01.i_0 (ite main@%_23_0 1 main@%c.0.i_0)))
                (=> main@_bb_1
...
(rule (let ((a!1 (and (main@_bb main@%c.0.i_0 main@%_3_0 @unknown_0)
                ...
                (=> main@_bb4_0 (= main@%_25_0 (= main@%c.0.i_0 main@%_3_0)))
                (=> main@_bb4_0 (= main@%_26_0 (> main@%c.0.i_0 (- 1))))
                (=> main@_bb4_0
                    (= main@%or.cond.i_0 (or main@%_25_0 main@%_26_0)))
                (=> main@_bb4_0 (not main@%or.cond.i_0))
                (=> main@_bb4_0 (= main@%_27_0 (xor main@%or.cond.i_0 true)))
