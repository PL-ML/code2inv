(set-info :original "/tmp/sea-lJU94V/6.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
    ...
    (main@_bb main@%x.0.i_1 main@%_11_0 main@%y.0.i_1 main@%_7_0)))
(rule (let ((a!1 (and (main@_bb main@%x.0.i_0 main@%_11_0 main@%y.0.i_0 main@%_7_0)
                true
                (= main@%_13_0 (< main@%x.0.i_0 main@%_7_0))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) main@%_13_0)
                (=> main@_bb1_0 (= main@%_15_0 (+ main@%x.0.i_0 1)))
                (=> main@_bb1_0 (= main@%_16_0 (> main@%_11_0 main@%y.0.i_0)))
                (=> main@_bb1_0
                    (= main@%y.0..i_0
                       (ite main@%_16_0 main@%y.0.i_0 main@%_11_0)))
                (=> main@_bb_1 (and main@_bb_1 main@_bb1_0))
                main@_bb_1
                (=> (and main@_bb_1 main@_bb1_0) (= main@%x.0.i_1 main@%_15_0))
  ...
  (=> a!1 (main@_bb main@%x.0.i_2 main@%_11_0 main@%y.0.i_2 main@%_7_0))))
(rule (let ((a!1 (and (main@_bb main@%x.0.i_0 main@%_11_0 main@%y.0.i_0 main@%_7_0)
                true
                (= main@%_13_0 (< main@%x.0.i_0 main@%_7_0))
                (=> main@_bb2_0 (and main@_bb2_0 main@_bb_0))
                (=> (and main@_bb2_0 main@_bb_0) (not main@%_13_0))
                (=> main@_bb2_0 (= main@%_18_0 (> main@%_7_0 0)))
                (=> main@_bb2_0 (= main@%_19_0 (< main@%_11_0 main@%y.0.i_0)))
                (=> main@_bb2_0
                    (= main@%or.cond.i_0 (and main@%_18_0 main@%_19_0)))
