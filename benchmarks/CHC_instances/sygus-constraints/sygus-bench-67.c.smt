(set-info :original "/tmp/sea-xTV4vj/67.pp.ms.o.bc")
...
(rule (let ((a!1 (and (main@_bb main@%_1_0 main@%y.0.i_0 main@%x.0.i_0)
                ...
                (=> main@_bb2_0 (= main@%_11_0 (> main@%y.0.i_0 (- 1))))
                (=> main@_bb2_0
