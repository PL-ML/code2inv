(set-info :original "/tmp/sea-WGxqEo/79.pp.ms.o.bc")
...
(let ((a!2 (and (main@entry @unknown_0)
                ...
                main@%_6_0
                (= main@%_7_0 (> main@%_5_0 (- 1)))
                main@%_7_0
                (or (= main@%_8_0 (= main@%_3_0 main@%_5_0)) a!1)
                main@%_8_0
  ...
  (=> a!2 (main@_bb main@%i.0.i_1 main@%_3_0 main@%_5_0 @unknown_0)))))
(rule (let ((a!1 (and (main@_bb main@%i.0.i_0 main@%_3_0 main@%_5_0 @unknown_0)
                true
                ...
                (=> main@_bb1_0 (= main@%_14_0 (< main@%i.0.i_0 main@%_5_0)))
                (=> main@_bb1_0 (= main@%_15_0 (ite main@%_14_0 1 0)))
                (=> main@_bb1_0
                    (= main@%.i.0.i_0 (+ main@%i.0.i_0 main@%_15_0)))
  ...
  (=> a!1 (main@_bb main@%i.0.i_2 main@%_3_0 main@%_5_0 @unknown_0))))
(rule (let ((a!1 (and (main@_bb main@%i.0.i_0 main@%_3_0 main@%_5_0 @unknown_0)
                true
                (= main@%_10_0 @unknown_0)
                (= main@%_12_0 (= main@%_11_0 0))
                ...
                (=> main@_bb2_0 (= main@%_17_0 (>= main@%i.0.i_0 main@%_3_0)))
                (=> main@_bb2_0 (= main@%_18_0 (< main@%i.0.i_0 0)))
                (=> main@_bb2_0
                    (= main@%or.cond.i_0 (and main@%_17_0 main@%_18_0)))
                (=> main@_bb2_0 (= main@%_19_0 (< main@%i.0.i_0 main@%_5_0)))
                (=> main@_bb2_0
                    (= main@%or.cond1.i_0 (and main@%or.cond.i_0 main@%_19_0)))
                (=> main@_bb2_0 main@%or.cond1.i_0)
