(set-info :original "/tmp/sea-vN2skr/83.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
         ...
         main@_bb_0
         (=> (and main@_bb_0 main@entry_0) (= main@%x.0.i_0 (- 5000)))
...
(rule (let ((a!1 (and (main@_bb main@%x.0.i_0 main@%y.0.i_0)
                ...
                (=> main@_bb2_0 (= main@%_10_0 (> main@%y.0.i_0 0)))
