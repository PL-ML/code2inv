(set-info :original "/tmp/sea-ICh5Wc/85.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
         ...
         main@_bb_0
         (=> (and main@_bb_0 main@entry_0) (= main@%x.0.i_0 (- 15000)))
...
(rule (let ((a!1 (and (main@_bb main@%x.0.i_0 main@%y.0.i_0)
                true
                (= main@%_11_0 (< main@%x.0.i_0 0))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) main@%_11_0)
                (=> main@_bb1_0 (= main@%_13_0 (+ main@%x.0.i_0 main@%y.0.i_0)))
                (=> main@_bb1_0 (= main@%_14_0 (+ main@%y.0.i_0 1)))
...
(rule (let ((a!1 (and (main@_bb main@%x.0.i_0 main@%y.0.i_0)
                ...
                (=> main@_bb2_0 (not main@%_16_0))
                (=> main@_bb2_0 (= main@%_17_0 (xor main@%_16_0 true)))
