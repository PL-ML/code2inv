(set-info :original "/tmp/sea-VUZbEu/88.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
         ...
         main@_bb_0
         (=> (and main@_bb_0 main@entry_0) (= main@%x.0.i_0 main@%_3_0))
         (=> (and main@_bb_0 main@entry_0) (= main@%lock.0.i_0 0))
         (=> (and main@_bb_0 main@entry_0) (= main@%y.0.i_0 main@%_6_0))
...
(rule (let ((a!1 (and (main@_bb main@%lock.0.i_0
                          ...
                          main@%x.0.i_0)
                true
                (= main@%_8_0 (= main@%x.0.i_0 main@%y.0.i_0))
                ...
                (=> main@_bb1_0 (= main@%not..i_0 (xor main@%_12_0 true)))
                (=> main@_bb1_0 (= main@%lock.1.i_0 (ite main@%not..i_0 1 0)))
                (=> main@_bb1_0 (= main@%_13_0 (ite main@%_12_0 1 0)))
                (=> main@_bb1_0 (= main@%y.1.i_0 (+ main@%y.0.i_0 main@%_13_0)))
...
(rule (let ((a!1 (and (main@_bb main@%lock.0.i_0
                ...
                (=> main@_bb2_0 (= main@%_15_0 (= main@%lock.0.i_0 1)))
                (=> main@_bb2_0 (not main@%_15_0))
                (=> main@_bb2_0 (= main@%_16_0 (xor main@%_15_0 true)))
