(set-info :original "/tmp/sea-RvM6dD/89.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
         ...
         main@_bb_0
         (=> (and main@_bb_0 main@entry_0) (= main@%x.0.i_0 main@%_11_0))
         (=> (and main@_bb_0 main@entry_0) (= main@%lock.0.i_0 1))
         (=> (and main@_bb_0 main@entry_0) (= main@%y.0.i_0 main@%_11_0))
...
(rule (let ((a!1 (and (main@_bb main@%lock.0.i_0
                          ...
                          main@%x.0.i_0)
                true
                (= main@%_13_0 (= main@%x.0.i_0 main@%y.0.i_0))
                (=> main@_bb1_0 (and main@_bb1_0 main@_bb_0))
                (=> (and main@_bb1_0 main@_bb_0) (not main@%_13_0))
                (=> main@_bb1_0 (= main@%_15_0 @unknown_0))
                (=> main@_bb1_0 (= main@%_17_0 (= main@%_16_0 0)))
                (=> main@_bb1_0 (= main@%not..i_0 (xor main@%_17_0 true)))
                (=> main@_bb1_0 (= main@%lock.1.i_0 (ite main@%not..i_0 1 0)))
                (=> main@_bb1_0 (= main@%_18_0 (ite main@%_17_0 1 0)))
                (=> main@_bb1_0 (= main@%y.1.i_0 (+ main@%y.0.i_0 main@%_18_0)))
...
(rule (let ((a!1 (and (main@_bb main@%lock.0.i_0
                ...
                (=> main@_bb2_0 (= main@%_20_0 (= main@%lock.0.i_0 1)))
                (=> main@_bb2_0 (not main@%_20_0))
                (=> main@_bb2_0 (= main@%_21_0 (xor main@%_20_0 true)))
