(set-info :original "/tmp/sea-SgsuMi/96.pp.ms.o.bc")
...
(rule (=> (and (main@entry @unknown_0)
    ...
    (main@_bb main@%i.0.i_1 main@%j.0.i_1 main@%_5_0)))
(rule (let ((a!1 (and (main@_bb main@%i.0.i_0 main@%j.0.i_0 main@%_5_0)
                true
                (= main@%_9_0 (> main@%i.0.i_0 main@%_5_0))
                ...
                main@_bb_1
                (=> (and main@_bb_1 main@_bb1_0) (= main@%j.0.i_1 main@%_12_0))
                (=> (and main@_bb_1 main@_bb1_0) (= main@%i.0.i_1 main@%_11_0))
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%j.0.i_2 main@%j.0.i_1))
                (=> (and main@_bb_1 main@_bb1_0)
                    (= main@%i.0.i_2 main@%i.0.i_1)))))
  (=> a!1 (main@_bb main@%i.0.i_2 main@%j.0.i_2 main@%_5_0))))
(rule (let ((a!1 (and (main@_bb main@%i.0.i_0 main@%j.0.i_0 main@%_5_0)
                true
                (= main@%_9_0 (> main@%i.0.i_0 main@%_5_0))
                (=> main@_bb2_0 (and main@_bb2_0 main@_bb_0))
                (=> (and main@_bb2_0 main@_bb_0) main@%_9_0)
                (=> main@_bb2_0 (= main@%_14_0 (= main@%i.0.i_0 main@%j.0.i_0)))
