...
( define-fun trans-f ( ( a Int )( j Int )( k Int )( m Int )( a! Int )( j! Int )( k! Int )( m! Int )( a_0 Int )( j_0 Int )( j_1 Int )( k_0 Int )( k_1 Int )( k_2 Int )( k_3 Int )( m_0 Int )( m_1 Int )( m_2 Int )( m_3 Int ) ) Bool
	( or
		( and
			( = k_2 k )
			( = m_1 m )
...
( assert ( not
	( =>
		( pre-f a j k m a_0 j_0 j_1 k_0 k_1 k_2 k_3 m_0 m_1 m_2 m_3  )
		( inv-f a j k m )
	)
))
...
( assert ( not
	( =>
		( and
			( inv-f a j k m )
			( trans-f a j k m a! j! k! m! a_0 j_0 j_1 k_0 k_1 k_2 k_3 m_0 m_1 m_2 m_3 )
		)
		( inv-f a! j! k! m! )
	)
))
...
( assert ( not
	( =>
		( inv-f a j k m  )
		( post-f a j k m a_0 j_0 j_1 k_0 k_1 k_2 k_3 m_0 m_1 m_2 m_3 )
	)
))
