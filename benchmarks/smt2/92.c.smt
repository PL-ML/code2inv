...
( define-fun trans-f ( ( x Int )( y Int )( x! Int )( y! Int )( x_0 Int )( y_0 Int )( y_1 Int )( y_2 Int ) ) Bool
	( or
		( and
			( = y_1 y )
			( = y_1 y! )
...
( assert ( not
	( =>
		( and
			( inv-f x y )
			( trans-f x y x! y! x_0 y_0 y_1 y_2 )
		)
		( inv-f x! y! )
	)
))
