...
mkdir -p tmp_grammar
file=$(ls ../../benchmarks/CHC_instances/sygus-constraints-graphs/ | head -$num | tail -1)
graph_file="../../benchmarks/CHC_instances/sygus-constraints-graphs/$file"
vc_file="../../benchmarks/CHC_instances/sygus-constraints/${file::-5}"
...
./run_solver_file.sh $graph_file $vc_file specs/chc_spec
